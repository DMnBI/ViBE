...
def run_pretrain(args = None):
    ...
    if model_args.config_name:
        config = ViBEConfig.from_pretrained(model_args.config_name, **config_kwargs)
    elif model_args.model_name_or_path:
        config = ViBEConfig.from_pretrained(model_args.model_name_or_path, **config_kwargs)
    else:
        config = ViBEConfig()
    ...
    if model_args.tokenizer_name:
        tokenizer = ViBETokenizer.from_pretrained(model_args.tokenizer_name, **tokenizer_kwargs)
    elif model_args.model_name_or_path:
        tokenizer = ViBETokenizer.from_pretrained(model_args.model_name_or_path, **tokenizer_kwargs)
    else:
        raise ValueError(
    ...
    if model_args.model_name_or_path:
        model = ViBEForMaskedLM.from_pretrained(
        ...
        model = ViBEForMaskedLM._from_config(config)
    ...
    if data_args.line_by_line:
        ...
        def tokenize_function(examples):
            ...
            return tokenizer(
                ...
                # We use this option because DataCollatorForKmerModeling (see below) is more efficient when it
        ...
        # We use `return_special_tokens_mask=True` because DataCollatorForKmerModeling (see below) is more
